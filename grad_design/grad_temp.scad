		...
		translate(v = [0, 0, -6.0000000000]) {
			translate(v = [1.5000000000, 0, 0]) {
				translate(v = [0, -19.0000000000, 0]) {
					polyhedron(faces = [[0, 1, 2], [2, 3, 4, 1], [4, 3, 5], [5, 4, 1, 0], [0, 5, 3, 2]], points = [[0, 0, 0], [2.3200000000, 0, 0], [0, 4.0000000000, 0], [0, 4.0000000000, 12.0000000000], [2.3200000000, 0, 12.0000000000], [0, 0, 12.0000000000]]);
				}
			}
		}
	}
