...
/*-----------------------------------------------
              @(target):= _get_rand_array.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__get_rand_array

#else
#  define SWIG_init    init_get_rand_array

#endif
#define SWIG_name    "_get_rand_array"
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "get_rand_array", _wrap_get_rand_array, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
