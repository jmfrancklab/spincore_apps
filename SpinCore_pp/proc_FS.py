...
fl.next('offset')
fl.plot(offset_plot['field',9],alpha=0.35,label=r'$B_{0} = %0.1f G$ (raw)'%offset_plot.getaxis('field')[9])
fl.plot(offset_plot_shift['field',9],alpha=0.35,label=r'$B_{0} = %0.1f G$ (time shift)'%offset_plot.getaxis('field')[9])
