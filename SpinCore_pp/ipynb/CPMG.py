...
figure();title(r'DATASET: %s, Estimated F($T_{2}$,$\Omega$), $\lambda$ = %0.4f'%(id_string,heel_lambda))
...
figure(figsize=(13,4));suptitle('DATASET 1')
subplot(121);subplot(121).set_title('ABS DATA')
image(abs(d_T2))
subplot(122);subplot(122).set_title('ABS FIT (k * x.T)')
image(abs(nd_fit))

figure(figsize=(13,4))
subplot(121);subplot(121).set_title('DATA - FIT')
image(nd_residual)
subplot(122);subplot(122).set_title('ABS (DATA - FIT))')
