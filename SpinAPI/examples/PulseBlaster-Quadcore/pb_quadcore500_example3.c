 ...
 */
 ...
 /**
 * \file pb-Quad_Core500_example3.c
 * \brief PulseBlaster Quad-Core Example 3
 *
 * This program is an example to show that different cores can generate outputs
 * that are completely independent from the outputs of other cores.  It is 
 * identical to example 3, except that the pattern is repeated 3 times.
 * \ingroup QuadCore
 */
...
#define CLOCK 500.0  //This is the internal ON-CHIP frequency which will differ from the external ON-BOARD oscillator
...
main (void)
{
	...
	printf ("Example 3\n---------\n");
	printf ("This program is an example to show that different cores can generate outputs\nthat are completely independent from the outputs of other cores.\n\n");
...
/********* Program Core3 ******************/
	...
	pb_4C_inst (1, 12.0 * ns);
	pb_4C_inst (0, 12.0 * ns);
	pb_4C_inst (1, 12.0 * ns);
	pb_4C_inst (0, 12.0 * ns);
	pb_4C_inst (1, 12.0 * ns);
	pb_4C_inst (0, 12.0 * ns);
