/*! \file incl_3200.c
 * \brief This program offers a simple example of how to use the spinpts3200 function.
 * The  spinpts3200 function is designed to control PTS3200 frequency synthesizers when 
 ...
 * between 1.0 and 3199.999 999, corresponding to 1.0 MHz and 3199.999 999 MHz
 * respectively.  Digits beyond the 6th decimal place will be ignored. 
 *
 * *****NOTE******* Actual resolution of output signal for the PTS3200 is 1 Hz 
 ...
 * for lower resolution but they will be ignored by the PTS3200.
 *
 *------------------------------------------------------------------------------
 * NOTE: This version only supports control of the PTS3200 frequency synthesizer.
 *
