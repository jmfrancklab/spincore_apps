 ...
 * The program will not work properly for 24-bit designs. It is intended to test
 * the maximum pulse-sequence length for design 8-13.
...
main(int argc, char **argv)
{
  ...
  printf ("Copyright (c) 2010 SpinCore Technologies, Inc.\n\n");
	...
	printf("This example program tests the maximum pulse-sequence length (262.144 us) of\nthe 8-13 PBESR-Pro-II design. Channel 1 outputs a 42.144 us pulse followed by\nalternating 20 us pulses on Channels 2 and 3. All channels are off for 60 us,\nthen the program repeats indefinitely.\n\n");
	...
	*/
	pb_inst_hs8("00000001",42.144*us);
	pb_inst_hs8("00000010",20.0*us);   
	pb_inst_hs8("00000100",20.0*us);
	pb_inst_hs8("00000010",20.0*us);
	pb_inst_hs8("00000100",20.0*us);
	pb_inst_hs8("00000010",20.0*us);
	pb_inst_hs8("00000100",20.0*us);
