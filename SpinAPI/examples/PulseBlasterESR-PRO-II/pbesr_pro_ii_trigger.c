 ...
 *
 * This program will generate a software trigger. The board will start outputting
 * data stored in its memory counter. The board can be stopped using reset.c
...
int main(int argc, char **argv)
{
  ...
  printf ("Copyright (c) 2010 SpinCore Technologies, Inc.\n\n");
	...
	printf("SpinCore Technologies PulseBlasterESR-Pro-II Trigger Program\n\n");
	...
	printf("Board triggering complete.\n");
