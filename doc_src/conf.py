# -*- coding: utf-8 -*-
#
# spincore_apps documentation build configuration file, created by
# sphinx-quickstart on Wed Jul 12 9:08:00 2023.
#
...
sys.path.insert(0, os.path.abspath('../Spincore_pp'))
sys.path.insert(0, os.path.abspath('../Instrumentation'))
...
project = 'spincore_apps'
copyright = '2023, John M. Franck group'
...
htmlhelp_basename = 'spinCoreAppsdoc'
